...
[ -f meteor-1.0.tgz ] || wget http://www.cs.cmu.edu/~alavie/METEOR/old/meteor-1.0.tgz || error
[ -f tercom-0.7.25.tgz ] || wget http://www.cs.umd.edu/~snover/tercom/tercom-0.7.25.tgz || error
[ -f terp-pt.v1.tgz ] || wget http://www.umiacs.umd.edu/~snover/terp/downloads/terp-pt.v1.tgz || error
trap error ERR
